...
bool cmpEscoreNome(Escores2 &e1, Escores2 &e2)
{
...
int main()
{
  ...
  std::cout << "Ordenacao dos escores por ordem crescente dos pontos dos jogadores, por atividade" << std::endl;
  std::cout << std::endl;
  ...
  std::cout << "Ordenacao dos escores por ordem alfabetica, com pontuacao total" << std::endl;
  std::cout << std::endl;
  std::sort(u.begin(), u.end(), cmpEscoreNome);
  ...
  std::cout << std::endl;
  std::cout << "Ordenacao dos escores por ordem crescente dos pontos dos jogadores, por pontuacao total" << std::endl;
  std::cout << std::endl;
